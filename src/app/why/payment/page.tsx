...
export async function generateMetadata(): Promise<Metadata> {
  return await getMetadataForPage(
    ...
    'Гибкие варианты оплаты для вашего удобства: наличные, карты, рассрочка'
  );
}
            ...
            <section className="page-centered mt-5 max-w-[1300px] flex">
                ...
                <div className="w-[100%] lg:ml-5 lg:max-w-[75%]">
                    ...
                    <div className="pl-5 lg:pl-0">
                        <PathPage />
                        <h1 className="text-black text-[28px] mt-2.5 leading-8 lg:text-[40px] lg:leading-12 font-[600]">Предоставляем разные варианты оплаты</h1>
                    </div>

                    {/* Основной контент */}
                    <div className="mt-7.5 font-[600] shadow-xs p-5 lg:p-7.5 rounded-lg">
                        <PageDescriptionBlock pageSlug="why-payment" />
                    </div>
                </div>
            </section>
